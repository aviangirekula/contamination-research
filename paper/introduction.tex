...
\begin{itemize}
 ...
 \item \textbf{RQ3 (choice of instrument).} Do the adjustments that make a detector
 better at membership discrimination also make it better at predicting leakage, or do
 the two objectives come apart?
\end{itemize}
...
\subsection{Roadmap}
Section~\ref{sec:background} explains benchmarks, memorization, and every technical
term and statistical tool this paper uses, and then states the assumption chain that
