...
fires confidently~\cite{carlini2022lira}.
...
\begin{itemize}
  ...
  \item \textbf{An empirical contamination~$\rightarrow$~memorization~$\rightarrow$~
  leakage link.} We correlate per-item contamination scores against an extraction
  ...
  sits inside the Pile, against regex-detected PII leakage~\cite{lukas2023pii},
  quantifying whether weak contamination signal nonetheless predicts concrete exposure.
\end{itemize}
